...
class TestImagesToDirectoryExporter:
    ...
    def test_animation_format_same_as_source_with_data_item(self, tmpdir, qapp,
                                                            settings):
        ...
        with patch.object(animated_item,
                          'to_same_as_source_bytes') as mock_same:
    ...
    def test_animation_format_default_selection(self, tmpdir, qapp, settings):
        ...
        default_format = settings.valueOrDefault(
    ...
    def test_quality_preservation_with_same_as_source(self, tmpdir, qapp,
                                                      settings):
        ...
        animated_item = BeeAnimatedDataItem(original_data,
                                            filename='high_quality.gif')
        animated_item.save_id = 1
        scene.addItem(animated_item)

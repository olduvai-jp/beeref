...
class AnimationGenerator:
    ...
    def create_animation_data(self, 
        ...
        try:
            ...
            logger.debug(f"Creating animation from {len(image_paths)} images at {fps} FPS")
            ...
            if animation_data:
                ...
                logger.info(f"Successfully created animation from {len(image_paths)} images")
...
def create_animation_from_sequence(image_paths: List[str], 
                                 fps: Optional[int] = None,
                                 output_format: str = 'gif') -> Optional[Dict[str, Any]]:
    """

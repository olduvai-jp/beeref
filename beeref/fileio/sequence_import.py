...
from .sequence_detection import (
    SequenceDetector, SequenceGroup, detect_image_sequences, get_sequence_info
)

logger = logging.getLogger(__name__)


def create_sequence_item_from_files(file_paths: List[str], 
                                    fps: float = 12.0,
...
def import_sequences_from_directory(directory_path: str,
                                    fps: float = 12.0,
